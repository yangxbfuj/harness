...
async def sequentialthinking(
    ...
    isRevision: Annotated[
        Optional[bool], "Whether this revises previous thinking"
    ] = False,
    revisesThought: Annotated[
        Optional[int], "Which thought is being reconsidered (minimum 1)"
    ] = None,
    branchFromThought: Annotated[
        Optional[int], "Branching point thought number (minimum 1)"
    ] = None,
    ...
    * Hypothesis verification
    ...
    server_params = StdioServerParameters(
        ...
        args=[
            ...
            "-i",
            "--rm",
            "docker.1ms.run/mcp/sequentialthinking",
