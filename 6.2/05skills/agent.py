...
TOOLS = [
    ...
    {"type": "function", "function": {"name": "run_edit", "description": "使用该工具编辑文件",
     ...
     {"type": "function", "function": {"name": "load_skills", "description": "根据名称加载指定的知识",
     "parameters": {"type": "object", "properties": {"name": {"type": "string", "description": "待加载的skills名称"}}, "required": ["name"]}}},
]
